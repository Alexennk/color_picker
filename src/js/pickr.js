...
import buildPickr from './template.js';
import {createPopper} from 'https://cdn.jsdelivr.net/npm/nanopop/lib/nanopop.min.mjs';
...
export default class Pickr {
    ...
    _bindEvents() {
        ...
        const eventBindings = [
            ...
            _.on(_root.interaction.result2, ['keyup', 'input'], e => {
            ...
            _.on(_root.interaction.result3, ['keyup', 'input'], e => {
            ...
            _.on(_root.interaction.result4, ['keyup', 'input'], e => {
            ...
            _.on(_root.interaction.result2, ['focus', 'blur'], e => {
            ...
            // Detect user input and disable auto-recalculation
            _.on(_root.interaction.result3, ['focus', 'blur'], e => {
                this._recalc = e.type === 'blur';
                this._recalc && this._updateOutput(null);
            }),
            ...
            // Detect user input and disable auto-recalculation
            _.on(_root.interaction.result4, ['focus', 'blur'], e => {
                this._recalc = e.type === 'blur';
                this._recalc && this._updateOutput(null);
            }),
        ...
        if (options.adjustableNumbers) {
            ...
            _.adjustableInputNumbers(_root.interaction.result2, (o, step, index) => {
            ...
            _.adjustableInputNumbers(_root.interaction.result3, (o, step, index) => {
                const range = ranges[this.getColorRepresentation().toLowerCase()];
            ...
            _.adjustableInputNumbers(_root.interaction.result4, (o, step, index) => {
                const range = ranges[this.getColorRepresentation().toLowerCase()];
    ...
    _updateOutput(eventSource) {
        ...
        if (_root.interaction.type()) {
            ...
            console.log(method);
                ...
                _root.interaction.result2.value = typeof _color[method] === 'function' ?
                _color['toRGBA']().toString(options.outputPrecision) : '';

                _root.interaction.result3.value = typeof _color[method] === 'function' ?
                _color['toCMYK']().toString(options.outputPrecision) : '';

                _root.interaction.result4.value = typeof _color[method] === 'function' ?
                _color['toHSLA']().toString(options.outputPrecision) : '';;
        }
